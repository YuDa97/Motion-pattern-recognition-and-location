...
CNN_NSL_Compare = pd.read_excel('./runs/CNNParameterTuning/ResultCompare.xlsx')
def plot_cdf(df):
    ...
    #plt.show()
    plt.savefig('./Figure/NN_NSL(k=0.28)_Compare_cdf.jpg',format='jpg',bbox_inches = 'tight',dpi=300)
...
#plot_curve(KernelSizeError)
plot_cdf(CNN_NSL_Compare)
